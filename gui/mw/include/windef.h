...
#ifndef VXWORKS
/* yios typedef unsigned char 		UCHAR;*/
typedef unsigned short 		USHORT;
typedef unsigned long		ULONG;
#ifndef __ITRON_TYPES_h_ /* FIXME RTEMS hack*/
/* yios typedef unsigned int		UINT;*/
#endif
...
typedef char *			PSZ;
#ifndef __ITRON_TYPES_h_
/* yios typedef int                 	INT;*/
#endif
/* yios typedef unsigned int        	*PUINT; */
...
/* yios typedef CHAR *PCHAR; */
typedef CHAR *LPCH, *PCH;
typedef CONST CHAR *LPCCH, *PCCH;
typedef CHAR *NPSTR;
/* yios typedef CHAR *LPSTR, *PSTR;*/
/* yios add */
typedef CHAR* LPSTR;

/* yios typedef CONST CHAR *LPCSTR, *PCSTR;*/
/* yios add */
